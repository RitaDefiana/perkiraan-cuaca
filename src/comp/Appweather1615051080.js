...
export default class RamalanCuaca extends React.Component {
  ...
  '&appid=48e95bedbf5b77c5d70b45960e6dbd4a&units=metric';
  fetch (url)
  ...
  render() {
    ...
    <View style={styles.containerMain}>
      ...
      <View style={styles.box5}>
          <Text style={{ textAlign: 'center', padding: 3, fontSize: 20 , color: '#E8F5E9'}}>Masukan Kota</Text>
      ...
      <View style={styles.boxFotter}>
          <Text style={{ textAlign: 'center', padding: 18, fontSize: 14}} >#JaenKuliahPTI</Text>
      </View>
